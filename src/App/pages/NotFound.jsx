    ...
    return (
        <div className="h-screen  font-bold flex flex-col items-center w-screen bg-purple-200">
            ...
            <div className="flex-1 flex flex-col items-center justify-center bg-purple-50 w-screen z-20">
                ...
                <h1 className="text-2xl text-center text-gray-500 font-extralight animate-ping">Not found</h1>
                <h1 className="text-xs text-center text-gray-500 font-light">Powered By Ciql</h1>
            </div>
        </div>
    )
} 
